...
public class LoadingSplashActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //Setting golden gate bridge image at runtime because it would sometimes fail to appear when set only in xml.
        goldenGate = (ImageView) findViewById(R.id.goldengate);
        Drawable gatePic = ContextCompat.getDrawable(LoadingSplashActivity.this, R.drawable.golden_gate);
        goldenGate.setImageDrawable(gatePic);
    ...
    //Alert Dialog To check if the user wants to try again to find location
    public void checkGPS()
    {
        new AlertDialog.Builder(this)
                .setTitle("No GPS")
                .setMessage("Cannot Find Location\nTry Again?")
                .setNegativeButton("No", null)
                .setPositiveButton("Yes", new onYesToTryAgainHandler())
                .create().show();
    }

    //Inner class to relaunch the location permissions and find location
    public class onYesToTryAgainHandler implements DialogInterface.OnClickListener
    {
        @Override
    ...
    public void GetLocationStartAPI()
    {
        ...
        {
            Toast.makeText(this, "GPS Location Not Found", Toast.LENGTH_LONG).show();
            checkGPS();
        }
    ...
    //Alert Dialog to inform the user that there is no internet
    public void checkInternet()
    {
        new AlertDialog.Builder(LoadingSplashActivity.this)
                .setTitle("No Internet")
                .setMessage("No internet found\nTry Again?")
                .setNegativeButton("No", null)
                .setPositiveButton("Yes", new onYesToNoInternet())
                .create().show();
    }

    //Relaunch the asnc task if the user wants to try again
    public class onYesToNoInternet implements DialogInterface.OnClickListener
    {
        @Override
        public void onClick(DialogInterface dialog, int which)
        {
    ...
    class AsyncAPIShowRawJSON extends AsyncTask<LatLng, Void, PlacesListStringResults>
    {
        ...
        private String getJSONFromURL(String url)
        {
            ...
            {
                Toast.makeText(LoadingSplashActivity.this, "Internet Not Found", Toast.LENGTH_LONG).show();
                internet = false;
            }
        ...
        {
            //Makes a list of attraction places and puts it into our db class
            ...
            //Makes a list of dining places and puts it into our db class
            ...
            //Makes a list of accommodation places and puts it into our db class

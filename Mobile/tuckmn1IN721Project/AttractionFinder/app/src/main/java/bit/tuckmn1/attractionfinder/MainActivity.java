...
public class MainActivity extends AppCompatActivity
{
    ...
    //Inner class to start image downloads if the user decides
    ...
    //Inner class to start map fragment on button click
    ...
    //Simple method to decide which fragment to launch
    ...
    //Asybc Tasj To download place image
    class AsyncAPIGetPlaceImage extends AsyncTask<Void, Void, Bitmap>
    {
        private Bitmap getBitmapFromURL(String url)
        {
            ...
            //If phone memory becomes full, use rubber duck image instead
        ...
        //Creates a url to get the place image

...
namespace GardenReporterSkeleton
{
    public partial class Form1 : Form
    {
        ...
        ReportProcessor areaProcessor;
        ReportProcessor accountProcessor;
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            populateDummyData();
            areaProcessor = new ReportProcessor(gardenManager.DisplayArea);
            accountProcessor = new ReportProcessor(gardenManager.DisplayAccounts);
        }
        ...
        {
            gardenManager.ProcessGardens(areaProcessor);
        }

        private void btnCharges_Click(object sender, EventArgs e)
        {
            gardenManager.ProcessGardens(accountProcessor);
        }
